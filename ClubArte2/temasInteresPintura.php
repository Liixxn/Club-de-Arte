...
<body>
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="slide-inner">
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <img src="imgs/Actividades y taller/Taller-pintura.jpg" alt="">
                                    <div class="image-text">
                                        <p>En el taller de pintura trabajamos todas las técnicas pictóricas: la pintura al óleo, el acrílico, la acuarela, pintura matérica, etc… Además del dibujo con técnicas secas: lápiz de grafito, carboncillo, etc.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <img src="imgs/Actividades y taller/Taller_Infantil.jpg" alt="">
                                    <div class="image-text">
                                        <p>El taller consta de una primera parte introductoria con nociones básicas sobre la representación mediante el dibujo y la pintura.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <img src="imgs/Actividades y taller/taller-pinturas.jpg" alt="">
                                    <div class="image-text">
                                        <p>Para aquellos que ya demuestran una mayor experiencia, en cada elección temática se buscará una complejidad acorde a las habilidades adquiridas que fomente la adquisición y desarrollo de nuevas destrezas artísticas.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12" id="container-publicaciones">
