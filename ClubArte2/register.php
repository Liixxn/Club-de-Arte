        ...
        <div class="col-lg-6" id="div-form-registro">
            ...
            <form id="div-inputs-registro" class="col-sm-12" action="register.php" method="POST">
                ...
                <div class="div-inputs" id="div-input-numExpediente">
                    ...
                    <input min="1000000" type="number" name="nexpediente" id="nexpediente" placeholder="Número de expediente" value="<?php echo isset($_POST['nexpediente'])? $_POST['nexpediente']:''; ?>" required>
                </div>
                ...
                <div class="div-inputs" id="div-input-contrasena">
                    ...
                    <input minlength="4" type="password" name="contrasena" id="contrasena" placeholder="Contraseña" value="<?php echo isset($_POST['contrasena'])? $_POST['contrasena']:''; ?>" required>
                </div>
                <div class="div-inputs" id="div-input-contrasena2">
                    <label for="contrasena2">Repetir Contraseña</label>
                    <input minlength="4" type="password" name="contrasena2" id="contrasena2" placeholder="Repetir Contraseña" value="<?php echo isset($_POST['contrasena2'])? $_POST['contrasena2']:''; ?>" required>
                </div>
