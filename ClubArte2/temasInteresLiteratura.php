                        ...
                        <div class="slide-inner">
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/taller_lit.jpg" alt="">
                                        <div class="image-text">
                                            <p>El debate en torno a los talleres literarios parece no tener fin. ¿Sirven o no sirven? Los hay cada vez en mayor cantidad, y no solo de forma particular o en centros culturales sino también en forma de cursos universitarios oficiales de grado y posgrado</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/escribir-con-chicos.jpg" alt="">
                                        <div class="image-text">
                                            <p>Al mismo tiempo, se siguen alzando las voces que afirman que son un fraude, que el único modo de aprender a escribir leyendo y escribiendo mucho, que las clases más valiosas son las que se da uno mismo, etc.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/articles-384397_foto_g.jpg" alt="">
                                        <div class="image-text">
                                            <p>Un taller es un punto de encuentro, pero también una plataforma de investigación. Personal y social. En un taller no se aprenden tan solo recursos y trucos destinados a hacer más eficaz un texto, que también, sino a encontrar en la escritura una herramienta para conocernos mejor a nosotros mismos y al mundo que nos rodea.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
