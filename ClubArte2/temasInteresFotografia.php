                        ...
                        <div class="slide-inner">
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/Fotografía-digital.jpg" alt="">
                                        <div class="image-text">
                                            <p>Debes tener la capacidad de manejar un equipo fotográfico del tipo que sea (analógico o digital). Esto supone, entre otras habilidades, conocer el uso de lentes y filtros, saber cuál es el tipo de cámara adecuada para cada tipo de fotografía, saber usar trípodes, zooms, o microscopios ópticos.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/talleresfotoconce.jpg" alt="">
                                        <div class="image-text">
                                            <p>En esta función se incluye desde elegir las localizaciones adecuadas, como el tipo de luz, el tipo de cámara o determinar la composición de las imágenes o el contexto donde se va a llevar a cabo la sesión fotográfica. Además, deberás coordinar a las personas que ejerzan de modelo, su vestimenta, posturas, escenas, etc.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/funciones-fotografo-profesional-715x495.jpg" alt="">
                                        <div class="image-text">
                                            <p>Es importante que como profesional estés al tanto de todas las nuevas técnicas, tendencias y que conozcas a fondo los entresijos de la industria para ofrecer un trabajo diferente y atractivo.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
