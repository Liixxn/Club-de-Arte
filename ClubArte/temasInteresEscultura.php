                        ...
                        <div class="slide-inner">
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <img src="imgs/Actividades y taller/Aula-taller-de-escultura.jpg" alt="">
                                    <div class="image-text">
                                        <p>Ahora que artistas, arquitectos y decoradores las incluyen compulsivamente en sus proyectos, mezclando clasicismo y modernidad, te descubrimos este taller donde todo es único.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <img src="imgs/Actividades y taller/taller_escultura.jpg" alt="">
                                    <div class="image-text">
                                        <p>Es un privilegio y una obligación mantenerlo, pues el vaciado de esculturas a través de moldes de escayola es una técnica centenaria que da como resultado una obra única, aunque no sea original, porque se hacen a través de un trabajo manual y artesanal.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <img src="imgs/Actividades y taller/escultura.jpg" alt="">
                                    <div class="image-text">
                                        <p>Poseer vaciados era algo excepcional en la Europa del Renacimiento, solo las grandes familias nobiliarias o el papado se podían permitir estos museos de vaciados que eran un síntoma de estatus</p>
                                    </div>
                                </div>
                            </div>
