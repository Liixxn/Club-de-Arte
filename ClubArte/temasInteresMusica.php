                        ...
                        <div class="slide-inner">
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/Junta de Patronos ESMRS 2019 60.jpg" alt="">
                                        <div class="image-text">
                                            <p>Desde el nacimiento e incluso antes, tenemos contacto con la música.   Nuestros primeros aprendizajes se dan al ritmo de canciones de cuna y rondas infantiles, ya en el jardín infantil la música se hace imprescindible, con ella aprendemos modales, higiene, colores, formas, etc.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/EscuelaPopular5.jpg" alt="">
                                        <div class="image-text">
                                            <p>La formación musical no sólo les dará conocimientos para interpretar un instrumento musical, también les dará acceso a nociones y conceptos básicos de la música, también irán desarrollando su oído, se irán familiarizando con nuevos sonidos musicales y como lo mencionamos anteriormente esto repercutirá en la variedad y calidad de la música que decidan escuchar.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="image-container">
                                    <div class="image-container">
                                        <img src="imgs/Actividades y taller/24195-cierre-multitudinario-de-los-talleres-municipales-de-musica.jpg" alt="">
                                        <div class="image-text">
                                            <p>Además, para los adolescentes las clases de música se convierten en espacios de socialización, ocupación del tiempo libre y generación de retos. Aprender notas, partituras y canciones, trasciende a otras áreas del ser muy importantes en esta etapa de la vida como la disciplina, la constancia, el aumento de la autoestima e incluso ayuda a controlar la timidez o el miedo para hablar en público. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
